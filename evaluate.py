...
def argsp():
    ...
    aparser.add_argument('--SID', help='system id')
...
if __name__=='__main__':
    ...
    pars={'SID' : 'NYU1',
          'dataset_path' : '/scratch/thn235/projects/nugget/eligible0.win31.textWord2vec_nugget.pkl',
